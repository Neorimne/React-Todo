import todos, {addTask, toggleTask, removeTask, removeAllTasks} from "../redux/todoReducer";
...
describe("todos reducer", () => {
    ...
    test("should handle toggleTask action", () => {
        expect(todos([{taskText: 'Testing', id: 0, isCompleted: false}], {
    ...
    test("should handle removeTask action", () => {
        const testState = [{taskText: 'Testing', id: 0, isCompleted: false}, 
        {taskText: 'Testing2', id: 1, isCompleted: true}];
        expect(todos(testState, {
